...
// This is used in connection with a Svn checked out version
// to provide CLI based stuff to generate code etc..

// copy it into the top directory to use..
...
new HTML_FlexyFramework(  array(
    ...
    'version' => '1.3',
    'enable' => 'Core,Builder',
    'svn' => file_exists(dirname(__FILE__).'/.svn'),
    'appNameShort' => "Builder",
    'appName' => "Builder Applications",
    'database' => $db,
